...
const Article = ({ data }) => {
  ...
  return (
    <Layout>
      <>
        <SlugHead image={data.image} color={data.color} date={data.date} title={data.title} content={data.content} value={eggClick} onValueChange={value => setEggClick(value)} draw={draw} />
